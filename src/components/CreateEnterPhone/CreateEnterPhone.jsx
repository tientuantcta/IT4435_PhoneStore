...
const CreateEnterPhone = () => {
  return (
    <div className="right">
      <div className="right__content">
        <div className="right__title">Bảng điều khiển</div>
        <p className="right__desc">Tạo giao dịch nhập điện thoại</p>
        <div className="right__formWrapper">
          <form action="" method="post" encType="multipart/form-data">
            ...
            <div className="btn">Tạo giao dịch nhập điện thoại</div>
          </form>
        </div>
      </div>
    </div>
...
export default CreateEnterPhone;
